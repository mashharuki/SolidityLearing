...
/**
 * UniswapV2SwapExamples Contract
 */
contract UniswapV2SwapExamples {
        ...
        returns (uint amountOut)
    {
        ...
        // swapExactTokensForTokens function (sell)
        uint[] memory amounts = router.swapExactTokensForTokens(
            amountIn,
            amountOutMin,
            path,
    ...
    /**
     * Swap WETH to DAI 
     * swapSingleHopExactAmountOut function
     */
    ...
    /**
     * Swap DAI -> WETH -> USDC
     * swapMultiHopExactAmountOut function
     */
