...
contract Pair is ERC20, ERC721TokenReceiver {
    ...
    constructor(
        ...
        // nftがERC721に対応しているか確認する必要があるのではないか？ ⇨ これはトラストするのでだめ
        nft = _nft;
        ...
        returns (uint256 fractionalTokenAmount)
    {
        ...
        // @audit 上限値を設けなくて良いのかチェックしなくて良いのか？？　 2個目
    ...
    function withdraw(uint256 tokenId) public {
        ...
        // Crytpto Punks、Kittiesの様な特別なNFTは対応する？？ ← トラストするので除外？？
    ...
    function removeQuote(uint256 lpTokenAmount) public view returns (uint256, uint256) {
        uint256 lpTokenSupply = lpToken.totalSupply();
        // @audit totalSupplyが0以上でなくて良いのか？？ 3個目
    ...
    function _transferFrom(address from, address to, uint256 amount) internal returns (bool) {
        // @audit balanceOf[from] >= amount であることのチェックが必要なのではないか？ 5個目;
    ...
    function _baseTokenReserves() internal view returns (uint256) {
        // @audit address(this).balance >= msg.value であるチェックが抜けているのではないか？? 4個目
